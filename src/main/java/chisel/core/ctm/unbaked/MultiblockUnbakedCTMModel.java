...
import chisel.core.ctm.baked.MultiblockCTMBlockStateModel;
import chisel.core.ctm.logic.CTMLogic;
import chisel.core.ctm.logic.CTMLogicV16;
import chisel.core.ctm.logic.CTMLogicV4;
import chisel.core.ctm.logic.CTMLogicV9;
...
public class MultiblockUnbakedCTMModel extends AbstractUnbakedConnectedTextureBlockStateModel {
    ...
    public @NonNull BlockStateModel bake(@NonNull ModelBaker baker) {
        ...
        Material.Baked bakedOverlay2x2 = overlay2x2Material != null ? baker.materials().get(overlay2x2Material, model) : (layer1Material != null && kind.multiblockSize() == 2 && !kind.usesRandomTexture() ? baker.materials().get(layer1Material, model) : null);
        Material.Baked bakedOverlay3x3 = overlay3x3Material != null ? baker.materials().get(overlay3x3Material, model) : (layer1Material != null && kind.multiblockSize() == 3 && !kind.usesRandomTexture() ? baker.materials().get(layer1Material, model) : null);
        Material.Baked bakedOverlay4x4 = overlay4x4Material != null ? baker.materials().get(overlay4x4Material, model) : (layer1Material != null && kind.multiblockSize() == 4 && !kind.usesRandomTexture() ? baker.materials().get(layer1Material, model) : null);
        Material.Baked bakedOverlayV4 = overlayV4Material != null ? baker.materials().get(overlayV4Material, model) : (bakedOverlay2x2 != null ? bakedOverlay2x2 : (layer1Material != null && kind.isV4() ? baker.materials().get(layer1Material, model) : null));
        Material.Baked bakedOverlayV9 = overlayV9Material != null ? baker.materials().get(overlayV9Material, model) : (bakedOverlay3x3 != null ? bakedOverlay3x3 : (layer1Material != null && kind.isV9() ? baker.materials().get(layer1Material, model) : null));
        Material.Baked bakedOverlayV16 = overlayV16Material != null ? baker.materials().get(overlayV16Material, model) : (bakedOverlay4x4 != null ? bakedOverlay4x4 : (layer1Material != null && kind.isV16() ? baker.materials().get(layer1Material, model) : null));
        Material.Baked bakedOverlayR4 = overlayR4Material != null ? baker.materials().get(overlayR4Material, model) : (bakedOverlay2x2 != null ? bakedOverlay2x2 : (layer1Material != null && kind.isR4() ? baker.materials().get(layer1Material, model) : null));
        Material.Baked bakedOverlayR9 = overlayR9Material != null ? baker.materials().get(overlayR9Material, model) : (bakedOverlay3x3 != null ? bakedOverlay3x3 : (layer1Material != null && kind.isR9() ? baker.materials().get(layer1Material, model) : null));
        Material.Baked bakedOverlayR16 = overlayR16Material != null ? baker.materials().get(overlayR16Material, model) : (bakedOverlay4x4 != null ? bakedOverlay4x4 : (layer1Material != null && kind.isR16() ? baker.materials().get(layer1Material, model) : null));
        ...
        for (Direction face : Direction.values()) {
            ...
            if (kind.multiblockSize() == 2 && (bakedOverlayV4 != null || bakedOverlayR4 != null || bakedOverlay2x2 != null)) {
                ...
                Vector3f[] offsets = getOffsets(face, variant.waterOffset(), from, to);
            ...
            if (kind.multiblockSize() == 3 && (bakedOverlayV9 != null || bakedOverlayR9 != null || bakedOverlay3x3 != null)) {
            ...
            if (kind.multiblockSize() == 4 && (bakedOverlayV16 != null || bakedOverlayR16 != null || bakedOverlay4x4 != null)) {
    ...
    private Vector3f[] getOffsets(Direction face, boolean waterOffset, Vector3f from, Vector3f to) {
        float offset = 0.01f;
