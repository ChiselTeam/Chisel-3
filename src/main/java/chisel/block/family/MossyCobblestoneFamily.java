...
public class MossyCobblestoneFamily extends ChiselFamily {
    ...
    public void addTranslations(LangHelper lang) {
        ...
        lang.addBlock(getVariant("mossy_cobblestone_chaotic_small"), "Mossy Cobblestone", "Small Mossy Cobblestone Bricks");
        lang.addBlock(getVariant("mossy_cobblestone_circular"), "Mossy Cobblestone", "Circular");
        lang.addBlock(getVariant("mossy_cobblestone_cracked"), "Mossy Cobblestone", "Damaged Mossy Cobblestone Tiles");
        ...
        lang.addBlock(getVariant("mossy_cobblestone_dent"), "Mossy Cobblestone", "Mossy Cobblestone with Dent");
        ...
        lang.addBlock(getVariant("mossy_cobblestone_french"), "Mossy Cobblestone", "French Mossy Cobblestone Tiles");
        lang.addBlock(getVariant("mossy_cobblestone_french_2"), "Mossy Cobblestone", "French Mossy Cobblestone Tiles");
        ...
        lang.addBlock(getVariant("mossy_cobblestone_panel"), "Mossy Cobblestone", "Mossy Cobblestone with Panel");
        ...
        lang.addBlock(getVariant("mossy_cobblestone_small"), "Mossy Cobblestone", "Small Mossy Cobblestone Tiles");
        lang.addBlock(getVariant("mossy_cobblestone_soft"), "Mossy Cobblestone", "Mossy Cobblestone with Light Panel");
        lang.addBlock(getVariant("mossy_cobblestone_solid"), "Mossy Cobblestone", "Mossy Cobblestone with Dark Panel");
        lang.addBlock(getVariant("mossy_cobblestone_tiles_large"), "Mossy Cobblestone", "Large Mossy Cobblestone Tiles");
