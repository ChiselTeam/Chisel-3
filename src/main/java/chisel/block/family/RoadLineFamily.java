...
import chisel.block.RoadlineBlock;
...
public class RoadLineFamily extends ChiselFamily {
    public RoadLineFamily(BlockBehaviour.Properties props) {
        family = builder("road_line")
                .addVariant("road_line_double_white_center", RoadlineBlock::new, () -> props, ROAD_LINES)
                .addVariant("road_line_double_white_long", RoadlineBlock::new, () -> props, ROAD_LINES)
                .addVariant("road_line_double_white_side", RoadlineBlock::new, () -> props, ROAD_LINES)
                .addVariant("road_line_double_yellow_center", RoadlineBlock::new, () -> props, ROAD_LINES)
                .addVariant("road_line_double_yellow_long", RoadlineBlock::new, () -> props, ROAD_LINES)
                .addVariant("road_line_double_yellow_side", RoadlineBlock::new, () -> props, ROAD_LINES)
                .addVariant("road_line_white_center", RoadlineBlock::new, () -> props, ROAD_LINES)
                .addVariant("road_line_white_long", RoadlineBlock::new, () -> props, ROAD_LINES)
                .addVariant("road_line_white_side", RoadlineBlock::new, () -> props, ROAD_LINES)
                .addVariant("road_line_yellow_center", RoadlineBlock::new, () -> props, ROAD_LINES)
                .addVariant("road_line_yellow_long", RoadlineBlock::new, () -> props, ROAD_LINES)
                .addVariant("road_line_yellow_side", RoadlineBlock::new, () -> props, ROAD_LINES)
                .family();
    }
