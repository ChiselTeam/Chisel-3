...
public class IceFamily extends ChiselFamily {
    public IceFamily(BlockBehaviour.Properties props) {
        family = builder("ice")
                .addVariant(Blocks.ICE)
                .addVariant("ice_array", props, MULTIBLOCK_2X2)
                .addVariant("ice_braid", props)
                .addVariant("ice_chaotic_bricks", props, MULTIBLOCK_3X3)
                .addVariant("ice_chaotic_medium", props)
                .addVariant("ice_chaotic_small", props)
                .addVariant("ice_circular", props, CONNECTED)
                .addVariant("ice_cracked", props)
                .addVariant("ice_cracked_bricks", props)
                .addVariant("ice_cuts", props, MULTIBLOCK_4X4)
                .addVariant("ice_dent", props, CONNECTED)
                .addVariant("ice_encased_bricks", props, CONNECTED)
                .addVariant("ice_french_1", props)
                .addVariant("ice_french_2", props)
                .addVariant("ice_jellybean", props, MULTIBLOCK_2X2)
                .addVariant("ice_layers", props)
                .addVariant("ice_mosaic", props, CONNECTED)
                .addVariant("ice_ornate", props)
                .addVariant("ice_panel", props)
                .addVariant("ice_pillar", props, TBS)
                .addVariant("ice_pillar_carved", props, TBS)
                .addVariant("ice_pillar_convex", props, TBS)
                .addVariant("ice_pillar_greek_greek", props, TBS)
                .addVariant("ice_pillar_greek_plain", props, TBS)
                .addVariant("ice_pillar_ornamental", props, TBS)
                .addVariant("ice_pillar_plain_greek", props, TBS)
                .addVariant("ice_pillar_plain_plain", props, TBS)
                .addVariant("ice_prism", props)
                .addVariant("ice_raw", props)
                .addVariant("ice_road", props)
                .addVariant("ice_slanted", props, MULTIBLOCK_2X2)
                .addVariant("ice_small_bricks", props)
                .addVariant("ice_soft_bricks", props)
                .addVariant("ice_solid_bricks", props)
                .addVariant("ice_tiles_large", props, CONNECTED)
                .addVariant("ice_tiles_medium", props)
                .addVariant("ice_tiles_small", props)
                .addVariant("ice_triple_bricks", props)
                .addVariant("ice_twisted", props, TBS)
                .addVariant("ice_weaver", props, CONNECTED)
                .addVariant("ice_zag", props, AR)
                .family();
    }
