package io.github.chiselteam.chisel.client.model.special.waterstone;
...
import io.github.chiselteam.chisel.client.model.ctm.ARModel;
...
public class WaterstoneARModel extends ARModel {
    @Override
    public TextureMapping getTextureMapping() {
        return (new TextureMapping())
                ...
                .put(TextureSlot.LAYER0, new Material(BuiltInRegistries.FLUID.getKey(Fluids.WATER.getSource()).withPrefix("block/").withSuffix("_still")))
