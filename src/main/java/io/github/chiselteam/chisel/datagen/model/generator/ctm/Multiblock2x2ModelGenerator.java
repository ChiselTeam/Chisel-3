...
public class Multiblock2x2ModelGenerator extends VariantModelGenerator {

    @Override
    public TextureMapping getTextureMapping() {
        return VariantTextures.ctm(variant, textures -> textures.multiblock2x2Textures(VariantTextures.get(variant, "2x2").sprite()))
