...
public class R4ModelGenerator extends VariantModelGenerator {

    @Override
    public TextureMapping getTextureMapping() {
        return VariantTextures.ctm(variant, textures -> textures.multiblock2x2Textures(VariantTextures.get(variant, "r4").sprite()))
