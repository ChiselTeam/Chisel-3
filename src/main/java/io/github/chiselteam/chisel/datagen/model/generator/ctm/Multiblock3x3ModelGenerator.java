...
public class Multiblock3x3ModelGenerator extends VariantModelGenerator {

    @Override
    public TextureMapping getTextureMapping() {
        return VariantTextures.ctm(variant, textures -> textures.multiblock3x3Textures(VariantTextures.get(variant, "3x3").sprite()))
    ...
    public void generate(Variant variant, BlockModelGenerators blockModels) {
        ...
        Identifier modelLocation = ChiselModelTemplates.CTM_MULTIBLOCK_3x3.create(getBlock(), getTextureMapping(), blockModels.modelOutput);
