...
public class R9ModelGenerator extends VariantModelGenerator {

    @Override
    public TextureMapping getTextureMapping() {
        return VariantTextures.ctm(variant, textures -> textures.multiblock3x3Textures(VariantTextures.get(variant, "r9").sprite()))
