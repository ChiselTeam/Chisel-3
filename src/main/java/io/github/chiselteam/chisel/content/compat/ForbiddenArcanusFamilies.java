...
public class ForbiddenArcanusFamilies {
    ...
    static {
        FA_ARCANE_DARKSTONE = ChiselFamily.build("fa_arcane_darkstone", builder -> builder
                ...
                .texture("arcane_big_brick", "ctm_cornerless", Chisel.prefix("block/fa_arcane_darkstone/arcane_big_brick-ctm_corner"))
                .texture("arcane_big_brick", "ctm_horizontal", Chisel.prefix("block/fa_arcane_darkstone/arcane_big_brick"))
                .texture("arcane_big_brick", "ctm_vertical", Chisel.prefix("block/fa_arcane_darkstone/arcane_big_brick-ctm_corner"))
                ...
                .texture("arcane_conduit", "ctm_cornerless", Chisel.prefix("block/fa_arcane_darkstone/arcane_conduit-ctm_corner"))
                ...
                .texture("arcane_runes", "v16_row_0_column_0", Chisel.prefix("block/fa_arcane_darkstone/arcane_runes"))
                .addVariant("arcane_runes_glow", ChiselModelHandlers.V16).translation("arcane_runes_glow", "Arcane", "Runes Glow")
                .texture("arcane_runes_glow", "v16_row_0_column_0", Chisel.prefix("block/fa_arcane_darkstone/arcane_runes_glow"))
                .build());
