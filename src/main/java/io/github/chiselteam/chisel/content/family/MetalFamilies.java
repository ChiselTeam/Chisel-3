...
public class MetalFamilies {
    ...
    static {
        ...
        GOLD = ChiselFamily.build("gold", builder -> builder
                ...
                .texture("gold_adv", Chisel.prefix("block/gold/gold_125"))
                ...
                .texture("gold_brick", "bottom", Chisel.prefix("block/gold/gold_brick-top"))
                ...
                .texture("gold_cart", "bottom", Chisel.prefix("block/gold/gold_cart-top"))
                ...
                .texture("gold_ingots_large", "top", Chisel.prefix("block/gold/gold_cart-top"))
                .addVariant("gold_ingots_small", ChiselModelHandlers.TBS).translation("gold_ingots_small", "Block of Gold", "Small Golden Ingots")
                .texture("gold_ingots_small", "top", Chisel.prefix("block/gold/gold_brick-top"))
                ...
                .texture("gold_plates", "side", Chisel.prefix("block/gold/gold_plates-top"))
                ...
                .texture("gold_simple", "top", Chisel.prefix("block/gold/gold_cart-top"))
                ...
                .texture("gold_star_obsidian", "bottom", Chisel.prefix("block/gold/gold_star_obsidian-top"))
                .texture("gold_star_obsidian", "side", Chisel.prefix("block/gold/gold_star_obsidian-top"))
                ...
                .texture("gold_star_obsidian_purple", "side", Chisel.prefix("block/gold/gold_star_obsidian_purple-top"))
        ...
        IRON = ChiselFamily.build("iron", builder -> builder
                ...
                .texture("iron_brick", "bottom", Chisel.prefix("block/iron/iron_brick-top"))
                ...
                .texture("iron_coin_tails", "side", Chisel.prefix("block/iron/iron_coin_heads-side"))
                .addVariant("iron_crate_dark", ChiselModelHandlers.TBS).translation("iron_crate_dark", "Block of Iron", "Dark Iron Crate")
                .texture("iron_crate_dark", "bottom", Chisel.prefix("block/gold/gold_crate_dark-bottom"))
                .addVariant("iron_crate_light", ChiselModelHandlers.TBS).translation("iron_crate_light", "Block of Iron", "Light Iron Crate")
                .texture("iron_crate_light", "bottom", Chisel.prefix("block/gold/gold_crate_light-bottom"))
                .texture("iron_crate_light", "top", Chisel.prefix("block/iron/iron_crate_dark-top"))
                .addVariant("iron_gears", ChiselModelHandlers.TBS).translation("iron_gears", "Block of Iron", "Iron Gears")
                .texture("iron_gears", "bottom", Chisel.prefix("block/iron/iron_gears-top"))
                ...
                .texture("iron_ingots_small", "top", Chisel.prefix("block/iron/iron_crate_dark-top"))
                ...
                .texture("iron_plates", "side", Chisel.prefix("block/iron/iron_plates-top"))
                ...
                .texture("iron_vents", "bottom", Chisel.prefix("block/iron/iron_vents-top"))
                .build());
        ...
        NETHERITE = ChiselFamily.build("netherite", builder -> builder
                ...
                .texture("netherite_circular", "ctm_cornerless", Chisel.prefix("block/netherite/netherite_border_square-ctm_cornerless"))
                ...
                .texture("netherite_cuts", "4x4_row_0_column_0", Chisel.prefix("block/netherite/netherite_cuts"))
                .addVariant("netherite_dent", ChiselModelHandlers.CONNECTED).translation("netherite_dent", "Block of Netherite", "Dent")
                .texture("netherite_dent", "ctm_cornerless", Chisel.prefix("block/netherite/netherite_border_square-ctm_cornerless"))
                ...
                .texture("netherite_indent", "ctm_cornerless", Chisel.prefix("block/netherite/netherite_border_square-ctm_cornerless"))
                ...
                .texture("netherite_layers", Chisel.prefix("block/netherite/netherite_layers_connected"))
                ...
                .texture("netherite_meander_horizontal", "top", Chisel.prefix("block/netherite/netherite_meander_horizontal-bottom"))
                ...
                .texture("netherite_meander_vertical", "top", Chisel.prefix("block/netherite/netherite_meander_vertical-bottom"))
                .addVariant("netherite_mosaic", ChiselModelHandlers.CONNECTED).translation("netherite_mosaic", "Block of Netherite", "Mosaic")
                .texture("netherite_mosaic", "ctm_cornerless", Chisel.prefix("block/netherite/netherite_border_square-ctm_cornerless"))
                ...
                .texture("netherite_pillar", "top", Chisel.prefix("block/netherite/netherite_pillar-bottom"))
                ...
                .texture("netherite_pillar_basic", "top", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                ...
                .texture("netherite_pillar_basic_dent", "bottom", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                .texture("netherite_pillar_basic_dent", "top", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                ...
                .texture("netherite_pillar_basic_plain", "bottom", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                .texture("netherite_pillar_basic_plain", "top", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                ...
                .texture("netherite_pillar_basic_round", "bottom", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                .texture("netherite_pillar_basic_round", "top", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                ...
                .texture("netherite_pillar_basic_spiral", "bottom", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                .texture("netherite_pillar_basic_spiral", "top", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                ...
                .texture("netherite_pillar_classic", "top", Chisel.prefix("block/netherite/netherite_pillar_classic-bottom"))
                ...
                .texture("netherite_pillar_classic_large", "top", Chisel.prefix("block/netherite/netherite_pillar_classic_large-bottom"))
                ...
                .texture("netherite_pillar_ionic", "bottom", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                .texture("netherite_pillar_ionic", "top", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                ...
                .texture("netherite_pillar_ionic_dent", "bottom", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                .texture("netherite_pillar_ionic_dent", "side", Chisel.prefix("block/netherite/netherite_pillar_ionic-side"))
                .texture("netherite_pillar_ionic_dent", "top", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                .texture("netherite_pillar_ionic_dent", "vertical_both", Chisel.prefix("block/netherite/netherite_pillar_basic_dent-vertical_both"))
                .texture("netherite_pillar_ionic_dent", "vertical_none", Chisel.prefix("block/netherite/netherite_pillar_ionic-vertical_none"))
                ...
                .texture("netherite_pillar_ionic_plain", "bottom", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                .texture("netherite_pillar_ionic_plain", "side", Chisel.prefix("block/netherite/netherite_pillar_ionic-side"))
                .texture("netherite_pillar_ionic_plain", "top", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                .texture("netherite_pillar_ionic_plain", "vertical_both", Chisel.prefix("block/netherite/netherite_pillar_basic_plain-vertical_both"))
                .texture("netherite_pillar_ionic_plain", "vertical_none", Chisel.prefix("block/netherite/netherite_pillar_ionic-vertical_none"))
                ...
                .texture("netherite_pillar_ionic_round", "bottom", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                .texture("netherite_pillar_ionic_round", "side", Chisel.prefix("block/netherite/netherite_pillar_ionic-side"))
                .texture("netherite_pillar_ionic_round", "top", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                .texture("netherite_pillar_ionic_round", "vertical_both", Chisel.prefix("block/netherite/netherite_pillar_basic_round-vertical_both"))
                .texture("netherite_pillar_ionic_round", "vertical_none", Chisel.prefix("block/netherite/netherite_pillar_ionic-vertical_none"))
                ...
                .texture("netherite_pillar_ionic_spiral", "bottom", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                .texture("netherite_pillar_ionic_spiral", "side", Chisel.prefix("block/netherite/netherite_pillar_ionic-side"))
                .texture("netherite_pillar_ionic_spiral", "top", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                .texture("netherite_pillar_ionic_spiral", "vertical_both", Chisel.prefix("block/netherite/netherite_pillar_basic_spiral-vertical_both"))
                .texture("netherite_pillar_ionic_spiral", "vertical_none", Chisel.prefix("block/netherite/netherite_pillar_ionic-vertical_none"))
                ...
                .texture("netherite_pillar_large_basic_triple", "bottom", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                .texture("netherite_pillar_large_basic_triple", "top", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                ...
                .texture("netherite_pillar_large_ionic_triple", "bottom", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                .texture("netherite_pillar_large_ionic_triple", "top", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                .texture("netherite_pillar_large_ionic_triple", "vertical_both", Chisel.prefix("block/netherite/netherite_pillar_large_basic_triple-vertical_both"))
                ...
                .texture("netherite_pillar_meander", "bottom", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                .texture("netherite_pillar_meander", "top", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                .texture("netherite_pillar_meander", "vertical_both", Chisel.prefix("block/netherite/netherite_pillar_ionic-vertical_both"))
                ...
                .texture("netherite_pillar_meander_dent", "bottom", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                .texture("netherite_pillar_meander_dent", "side", Chisel.prefix("block/netherite/netherite_pillar_meander-side"))
                .texture("netherite_pillar_meander_dent", "top", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                .texture("netherite_pillar_meander_dent", "vertical_both", Chisel.prefix("block/netherite/netherite_pillar_basic_dent-vertical_both"))
                .texture("netherite_pillar_meander_dent", "vertical_none", Chisel.prefix("block/netherite/netherite_pillar_meander-vertical_none"))
                ...
                .texture("netherite_pillar_meander_plain", "bottom", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                .texture("netherite_pillar_meander_plain", "side", Chisel.prefix("block/netherite/netherite_pillar_meander-side"))
                .texture("netherite_pillar_meander_plain", "top", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                .texture("netherite_pillar_meander_plain", "vertical_both", Chisel.prefix("block/netherite/netherite_pillar_basic_plain-vertical_both"))
                .texture("netherite_pillar_meander_plain", "vertical_none", Chisel.prefix("block/netherite/netherite_pillar_meander-vertical_none"))
                ...
                .texture("netherite_pillar_meander_round", "bottom", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                .texture("netherite_pillar_meander_round", "side", Chisel.prefix("block/netherite/netherite_pillar_meander-side"))
                .texture("netherite_pillar_meander_round", "top", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                .texture("netherite_pillar_meander_round", "vertical_both", Chisel.prefix("block/netherite/netherite_pillar_basic_round-vertical_both"))
                .texture("netherite_pillar_meander_round", "vertical_none", Chisel.prefix("block/netherite/netherite_pillar_meander-vertical_none"))
                ...
                .texture("netherite_pillar_meander_spiral", "bottom", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                .texture("netherite_pillar_meander_spiral", "side", Chisel.prefix("block/netherite/netherite_pillar_meander-side"))
                .texture("netherite_pillar_meander_spiral", "top", Chisel.prefix("block/netherite/netherite_pillar_basic-bottom"))
                .texture("netherite_pillar_meander_spiral", "vertical_both", Chisel.prefix("block/netherite/netherite_pillar_basic_spiral-vertical_both"))
                .texture("netherite_pillar_meander_spiral", "vertical_none", Chisel.prefix("block/netherite/netherite_pillar_meander-vertical_none"))
                .addVariant("netherite_plate").translation("netherite_plate", "Block of Netherite", "Plate")
                .texture("netherite_plate", Chisel.prefix("block/netherite/netherite_plate_connected"))
                ...
                .texture("netherite_plate_connected", "ctm_cornerless", Chisel.prefix("block/netherite/netherite_border_square-ctm_cornerless"))
                .addVariant("netherite_polished").translation("netherite_polished", "Block of Netherite", "Polished")
                .texture("netherite_polished", Chisel.prefix("block/netherite/netherite_tiles_large"))
                ...
                .texture("netherite_tiles_large", "ctm_cornerless", Chisel.prefix("block/netherite/netherite_border_square-ctm_cornerless"))
                ...
                .texture("netherite_twisted", "top", Chisel.prefix("block/netherite/netherite_twisted-bottom"))
                ...
                .texture("netherite_lodestone", Chisel.prefix("block/netherite/netherite_lodestone_connected"))
                ...
                .texture("netherite_plank", Chisel.prefix("block/netherite/netherite_plank_connected"))
                ...
                .texture("netherite_shiny", Chisel.prefix("block/netherite/netherite_shiny_connected"))
                ...
                .texture("netherite_gem_1", Chisel.prefix("block/netherite/netherite_gem_1_connected"))
                ...
                .texture("netherite_gem_1_connected", "ctm_cornerless", Chisel.prefix("block/netherite/netherite_border_square-ctm_cornerless"))
                .addVariant("netherite_gem_2").translation("netherite_gem_2", "Block of Netherite", "Gem 2")
                .texture("netherite_gem_2", Chisel.prefix("block/netherite/netherite_gem_2_connected"))
                ...
                .texture("netherite_gem_2_connected", "ctm_cornerless", Chisel.prefix("block/netherite/netherite_border_square-ctm_cornerless"))
                .addVariant("netherite_gem_3").translation("netherite_gem_3", "Block of Netherite", "Gem 3")
                .texture("netherite_gem_3", Chisel.prefix("block/netherite/netherite_gem_3_connected"))
